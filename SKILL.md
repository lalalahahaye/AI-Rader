...
- **[default-sources.json](default-sources.json)**: RSS + `googleNews` URLs, **`filter.thesis.orGroups`** / `excludeKeywords`, `github.searchQuery` + `minStars`, `hackerNews.algoliaQueries`, `arxiv.queries`, `kickstarter.enabled`, `feed.capsByType` (incl. `paper`, `crowdfunding`), **`xTwitter.aiLeaders` / `aiInvestors`** (handles, limits).
...
| [default-sources.json](default-sources.json) | RSS, Google News, thesis `orGroups`, HN Algolia, arXiv, GitHub, optional KS/X, caps |
